...
assert.match(noticeGenerator, /selectedLicense: 'ISC AND MIT'/);
assert.match(noticeGenerator, /Feather-derived icons used by this application/);
assert.match(noticeGenerator, /https:\/\/github\.com\/lucide-icons\/lucide\/tree\/1\.29\.0/);
