...
for (const file of ['docs/PRODUCT_GUIDE.md','docs/ARCHITECTURE.md','docs/KNOWN_LIMITS.md','docs/BUILD_PLAN.md','docs/VALIDATION.md','docs/CHANGELOG.md','release-spec/README.md','THIRD_PARTY_NOTICES.txt','tools/windows/Freeze-Windows-Dependencies.cmd','tools/windows/Generate-Updater-Signing-Key.cmd','tools/windows/Install-Windows-Installer-Tooling.cmd']) assert.ok(fs.existsSync(file), `missing public contract: ${file}`);
