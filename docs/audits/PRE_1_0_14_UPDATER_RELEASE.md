...
| Version-tag protection | Active ruleset [24035029 — Protect version tags](https://github.com/360shvit/NodeEditor-Workbench/rules/24035029), verified through the GitHub API on 2026-09-26: `refs/tags/v*`, update/deletion/force-push restrictions, no exclusions or bypass actors; current-user bypass is `never`. Creation remains allowed. GitHub's Confirm access step is resolved. Rolling `updater-*` tags are outside its scope. |
